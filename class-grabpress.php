          ...
          try {
            ...
            if($height ==='' ) {
              $height = 360;
                ...
                //Here´s where the magic happens. We´re going to create a particular embed for custom client settings.
            $embed = Grabpress_API::create_embed( $auto_play, $video_id); 

                // Get the embed ID
            $embed_id = isset($embed->embed->id) ? $embed->embed->id : '';
            if ( $embed_id === '' ) {
